...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0">
  ...
  <table border=1>
    ...
    PosRow row = null;
    String[] columnInfLstName = "의뢰번호,접수번호,고객요청색상,수지Text,수지분석요망,시편송부여부,도막두께,샘플광,광택도코드,사용용도,영업담당자,고객사,사용지역,품명,품명구분,영업요청일,영업승인일,비고,도료업체,도료업체명,수지구분,시편개발의뢰일,시편개발예정일,시편개발완료일,시편개발송부일,시편송부정보,승인여부,색상코드,CCLBOM번호,CCLBOM등록일,색구분,색구분명,유사색상진행여부,설계담당,비고,셈플담당자,담당자연락처,색상확인활동,프로젝트성개발".split(",");
