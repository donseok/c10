...
<%@ page import="com.unionsteel.mes.c10.activity.common.C10FileUpload2" %>
...
List /* FileItem */ items = upload.parseRequest(request);
	...
	while (fIter.hasNext()) {
		...
		if (fitem.isFormField()) {
			...
			else if("INQ_NO".equals(f_field_name))  	INQ_NO 	= fitem.getString();
		}
	}
...
while (iter.hasNext()) {
    ...
    if(PAGE_ID!=null && !"".equals(PAGE_ID)){
			...
			ctx.put("INQ_NO"		    , INQ_NO);
			ctx.put("IMG_ADR"			, uploadFolder);	
			ctx.put("IMG_NM"			, fileName);	
			
			C10FileUpload2 fileUploead = new C10FileUpload2();
