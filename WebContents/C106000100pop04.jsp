...
<%--
 * PROGRAM NAME     :  C106000100pop04.jsp
 * VERSION          :  V1.0
 ...
 * ------------  ------    --------  ------------------------
 * 2015.12.09     V1.0      이돈석      Initial Version
--%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
String CCL_BOM_NO 	        = request.getParameter("CCL_BOM_NO");
String CCL_BOM_IMG_SEQ_NO 	= request.getParameter("CCL_BOM_IMG_SEQ_NO");
String rowId 			    = request.getParameter("rowId");
String parent_item 		    = request.getParameter("parent_item");
String IMG_RGS_TP		    = request.getParameter("IMG_RGS_TP");  //4로 값 고정
...
var pageConfiguration = '[' + 
      '{"itemType":"grid","renderTo":"C106000100pop04_Grid_1","xml":".\/header\/kr\/C106000100pop04\/C106000100pop04_Grid_1.xml","rowCnt":"2","vertical":"true","url":"gridC10Data.do","contextmenu":"false","borderline":"true","pageset":"true","split":"0","referenceItem":"C106000100pop04_Form_1","service":"C106000100pop04-service","actionType":"save"},' +
      '{"itemType":"messagebox","renderTo":"C106000100pop04_MessageBox_1","xml":".\/header\/kr\/C106000100pop04\/C106000100pop04_MessageBox_1.xml","service":"C106000100pop04-service"}' +
   ']';
...
function findMessage(referenceItem){
	uiCommon.message("C106000100pop04_MessageBox_1",referenceItem.getUserData("","appMsg"));
  	return true;
}
var vault = null;
function onVaultLoad() {
	...
	vault.setFormField("IMG_RGS_FLAG_ID", "<%=CCL_BOM_NO%>");	
	vault.setFormField("IMG_RGS_FLAG_ID2","<%=CCL_BOM_IMG_SEQ_NO%>");
...
function onLoadGrid(){
	var grid = items["C106000100pop04_Grid_1"];
	var customparam = {"CCL_BOM_NO":"<%=CCL_BOM_NO%>","CCL_BOM_IMG_SEQ_NO":"<%=CCL_BOM_IMG_SEQ_NO%>"};	
	var findUrl  = parametersC10('C106000100pop04_Grid_1','find',customparam);
	items['C106000100pop04_Grid_1'].loadData(findUrl);
	grid.getDhxGrid().detachEvent(onXleGrid);
}

function Grid_doLink(filename,rowId){
	var gridObj = items["C106000100pop04_Grid_1"].getDhxGrid();
...
function doImgDel(rowIdx){
	...
	var CCL_BOM_IMG_SEQ_NO	= gridObj.cellById(gridObj.getRowId(rowIdx),gridObj.getColIndexById("CCL_BOM_IMG_SEQ_NO")).getValue();
	...
	del_url += "&IMG_RGS_FLAG_ID="+CCL_BOM_NO;
	del_url += "&IMG_RGS_FLAG_ID2="+CCL_BOM_IMG_SEQ_NO;
	del_url += "&SEQ="+SEQ;
...
<div id="vault1"></div>
<div id="C106000100pop04_Grid_1" style="position:absolute;height:70px;width:430px;left:8px;top:260px;">
</div>
<div id="C106000100pop04_MessageBox_1" style="position:absolute;height:23px;width:445px;left:0px;top:332px;">
</div>
</body>
</html>
<script>
...
//<![CDATA[
   ui.initializeDHTMLX();  
   var onXleGrid = items["C106000100pop04_Grid_1"].onXLEEvent(onLoadGrid);     
//]]>
-->
</script>
