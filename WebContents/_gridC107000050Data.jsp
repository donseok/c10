				...
				if(rowSetList.size() > 0){
					for(int i = 0, listSize = rowSetList.size(); i < listSize; i++){
						...
						for(int j = 0 ; j < colOrder.length; j++) {
							...
							out.print("<cell ");
							if(rowMap.get("RULE_DT_NM_ID") != null){
								
								sRULE_DT_NM_ID  = rowMap.get("RULE_DT_NM_ID").toString();
								if(!sRULE_DT_NM_ID.equals("")){
									out.print(" bgColor='#66CCFF' type='ro' "); 
								}
								else{
								 //: TODO
								}
