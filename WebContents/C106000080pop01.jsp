...
<%--
 * PROGRAM NAME     :  C106000080pop01.jsp
 * VERSION          :  V1.0
 * DESCRIPTION      :  트린트롤 이미지 조회
 * DESIGNER NAME    :  이 돈 석
 ...
 * ------------  ------    --------  ------------------------
 * 2013.09.27     V1.0      이돈석      Initial Version
--%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
String PRT_ROLL_NO 	        = request.getParameter("PRT_ROLL_NO");
String PRT_ROLL_IMG_SEQ_NO 	= request.getParameter("PRT_ROLL_IMG_SEQ_NO");
...
var pageConfiguration = '[' + 
      '{"itemType":"grid","renderTo":"C106000080pop01_Grid_1","xml":".\/header\/kr\/C106000080pop01\/C106000080pop01_Grid_1.xml","rowCnt":"2","vertical":"true","url":"gridC10Data.do","contextmenu":"false","borderline":"true","pageset":"true","split":"0","referenceItem":"C106000080pop01_Form_1","service":"C106000080pop01-service","actionType":"save"},' +
      '{"itemType":"messagebox","renderTo":"C106000080pop01_MessageBox_1","xml":".\/header\/kr\/C106000080pop01\/C106000080pop01_MessageBox_1.xml","service":"C106000080pop01-service"}' +
   ']';
...
function refresh(referenceItem){ //grid selection clear event
    ...
    var findUrl = uiCommon.parameters('C106000080pop01_Form_1',referenceItem,'find');
    items[referenceItem].loadData(findUrl);	
}
...
function findMessage(referenceItem){
	uiCommon.message("C106000080pop01_MessageBox_1",referenceItem.getUserData("","appMsg"));
  	return true;
}
var vault = null;
function onVaultLoad() {
	...
	vault.setFormField("IMG_RGS_FLAG"	, "03");
	vault.setFormField("IMG_RGS_FLAG_ID", "<%=PRT_ROLL_NO%>");	
	vault.setFormField("IMG_RGS_FLAG_ID2","<%=PRT_ROLL_IMG_SEQ_NO%>");	
...
function onLoadGrid(){
	var grid = items["C106000080pop01_Grid_1"];
	var customparam = {"PRT_ROLL_NO":"<%=PRT_ROLL_NO%>","PRT_ROLL_IMG_SEQ_NO":"<%=PRT_ROLL_IMG_SEQ_NO%>"};	
	var findUrl  = parametersC10('C106000080pop01_Grid_1','find',customparam);
	items['C106000080pop01_Grid_1'].loadData(findUrl);
...
function doImgDel(rowIdx){
	var gridObj = items["C106000080pop01_Grid_1"].getDhxGrid();
	var PRT_ROLL_NO			= gridObj.cellById(gridObj.getRowId(rowIdx),gridObj.getColIndexById("PRT_ROLL_NO")).getValue();
	var PRT_ROLL_IMG_SEQ_NO	= gridObj.cellById(gridObj.getRowId(rowIdx),gridObj.getColIndexById("PRT_ROLL_IMG_SEQ_NO")).getValue();
	...
	del_url += "?IMG_RGS_FLAG=03";
	del_url += "&IMG_RGS_FLAG_ID="+PRT_ROLL_NO;
	del_url += "&IMG_RGS_FLAG_ID2="+PRT_ROLL_IMG_SEQ_NO;
	del_url += "&SEQ="+SEQ;
...
<div id="vault1"></div>
<div id="C106000080pop01_Grid_1" style="position:absolute;height:70px;width:430px;left:8px;top:260px;">
</div>
<div id="C106000080pop01_MessageBox_1" style="position:absolute;height:23px;width:445px;left:0px;top:332px;">
</div>
</body>
</html>
<script>
...
//<![CDATA[
   ui.initializeDHTMLX();  
   var onXleGrid = items["C106000080pop01_Grid_1"].onXLEEvent(onLoadGrid);     
//]]>
-->
</script>