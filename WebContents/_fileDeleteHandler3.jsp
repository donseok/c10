...
<%@ page import="com.unionsteel.mes.c10.activity.common.C10FileUpload3" %>
...
String IMG_RGS_FLAG_ID3 = request.getParameter("IMG_RGS_FLAG_ID3");
...
try{
	...
	ctx.put("IMG_RGS_FLAG_ID3"	, IMG_RGS_FLAG_ID3);
	...
	C10FileUpload3 fileUploead = new C10FileUpload3();
