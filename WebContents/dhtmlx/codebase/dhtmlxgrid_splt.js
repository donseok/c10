		...
		*/
            ...
            this.sync_headers=this._fake.sync_headers=function(){
            		...
            		for (var i=1; i<this.hdr.rows.length; i++){
						...
						if (ha!=hb)
						var rowspan = this._fake.hdr.rows[i].childNodes[0].rowspan;
						this._fake.hdr.rows[i].style.height=25*(rowspan||1)+"px";

						var rowspan = this.hdr.rows[i].childNodes[0].rowspan;
						this.hdr.rows[i].style.height=25*(rowspan||1)+"px";
