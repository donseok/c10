...
<%--
 * PROGRAM NAME     :  C106000050pop07.jsp
 * VERSION          :  V1.0
...
var pageConfiguration = '[' + 
      '{"itemType":"grid","renderTo":"C106000050pop07_Grid_1","xml":".\/header\/kr\/C106000050pop07\/C106000050pop07_Grid_1.xml","rowCnt":"2","vertical":"true","url":"gridC10Data.do","contextmenu":"false","borderline":"true","pageset":"true","split":"0","referenceItem":"C106000050pop07_Form_1","service":"C106000050pop07-service","actionType":"save"},' +
      '{"itemType":"messagebox","renderTo":"C106000050pop07_MessageBox_1","xml":".\/header\/kr\/C106000050pop07\/C106000050pop07_MessageBox_1.xml","service":"C106000050pop07-service"}' +
   ']';
...
function refresh(referenceItem){ //grid selection clear event
    ...
    var findUrl = uiCommon.parameters('C106000050pop07_Form_1',referenceItem,'find');
    items[referenceItem].loadData(findUrl);	
}
...
function findMessage(referenceItem){
	uiCommon.message("C106000050pop07_MessageBox_1",referenceItem.getUserData("","appMsg"));
  	return true;
}
var vault = null;
...
function onLoadGrid(){
	var grid = items["C106000050pop07_Grid_1"];
	var customparam = {"CLR_SUB_MTL_CD":"<%=CLR_SUB_MTL_CD%>","CLR_SUB_MTL_CD_SEQ_NO":"<%=CLR_SUB_MTL_CD_SEQ_NO%>"};	
	var findUrl  = parametersC10('C106000050pop07_Grid_1','find',customparam);
	items['C106000050pop07_Grid_1'].loadData(findUrl);
...
function Grid_doLink(filename,rowId){
	...
	var gridObj = items["C106000050pop07_Grid_1"].getDhxGrid();
...
<div id="vault1"></div>
<div id="C106000050pop07_Grid_1" style="position:absolute;height:70px;width:430px;left:8px;top:260px;">
</div>
<div id="C106000050pop07_MessageBox_1" style="position:absolute;height:23px;width:445px;left:0px;top:332px;">
</div>
</body>
</html>
<script>
...
//<![CDATA[
   ui.initializeDHTMLX();  
   var onXleGrid = items["C106000050pop07_Grid_1"].onXLEEvent(onLoadGrid);     
//]]>
-->
</script>