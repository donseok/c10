...
<%--
 * PROGRAM NAME     :  C106000140pop01.jsp
 * VERSION          :  V1.0
...
var pageConfiguration = '[' + 
      '{"itemType":"grid","renderTo":"C106000140pop01_Grid_1","xml":".\/header\/kr\/C106000140pop01\/C106000140pop01_Grid_1.xml","rowCnt":"2","vertical":"true","url":"gridC10Data.do","contextmenu":"false","borderline":"true","pageset":"true","split":"0","referenceItem":"C106000140pop01_Form_1","service":"C106000140pop01-service","actionType":"save"},' +
      '{"itemType":"messagebox","renderTo":"C106000140pop01_MessageBox_1","xml":".\/header\/kr\/C106000140pop01\/C106000140pop01_MessageBox_1.xml","service":"C106000140pop01-service"}' +
   ']';
...
function refresh(referenceItem){ //grid selection clear event
    ...
    var findUrl = uiCommon.parameters('C106000140pop01_Form_1',referenceItem,'find');
    items[referenceItem].loadData(findUrl);	
}
...
function findMessage(referenceItem){
	uiCommon.message("C106000140pop01_MessageBox_1",referenceItem.getUserData("","appMsg"));
  	return true;
}
var vault = null;
function onVaultLoad() {
	...
	vault.onAddFile = function(fileName) {
		...
		*/
		var gridObj = items['C106000140pop01_Grid_1'].getDhxGrid();
...
function onLoadGrid(){
	var grid = items["C106000140pop01_Grid_1"];
	var customparam = {"DGT_PRT_IMG_NO":"<%=DGT_PRT_IMG_NO%>","DGT_PRT_IMG_SEQ_NO":"<%=DGT_PRT_IMG_SEQ_NO%>"};	
	var findUrl  = parametersC10('C106000140pop01_Grid_1','find',customparam);
	items['C106000140pop01_Grid_1'].loadData(findUrl);
...
<div id="vault1"></div>
<div id="C106000140pop01_Grid_1" style="position:absolute;height:70px;width:430px;left:8px;top:260px;">
</div>
<div id="C106000140pop01_MessageBox_1" style="position:absolute;height:23px;width:445px;left:0px;top:332px;">
</div>
</body>
</html>
<script>
...
//<![CDATA[
   ui.initializeDHTMLX();  
   var onXleGrid = items["C106000140pop01_Grid_1"].onXLEEvent(onLoadGrid);     
//]]>
-->
</script>