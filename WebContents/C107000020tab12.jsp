...
function find(eventName,formDivObj,referenceItem){
    ...
    var findUrl = uiCommon.parameters4('C107000020_Form_1','C107000020tab12_Grid_1',customparam + eventName);
    items['C107000020tab12_Grid_1'].loadData(findUrl);
}
...
function onLoadGrid (){
	var customparam = '';
    var findUrl = uiCommon.parameters4('C107000020_Form_1','C107000020tab12_Grid_1',customparam + 'find');
    items['C107000020tab12_Grid_1'].loadData(findUrl);
