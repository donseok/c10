...
function copyFilm(referenceItem){
...
// 			items['C106000060_Grid_2'].addRow();
			...
			//최종 수요가명 공란 처리
			gridObj1.cells(gridObj1.getRowId(0), 1).setValue("");
			//용도명 공란 처리
			gridObj1.cells(gridObj1.getRowId(0), 3).setValue("");
			//ERP 전송일시 공란 처리
			gridObj1.cells(gridObj1.getRowId(0), 8).setValue("");
...
// 		    						alert("색상코드 : "+grid3.getCellValue(4,0));
		    						...
		    						if(tmpRow != 0){
			    						...
			    						var compareCode = grid3.getCellValue(tmpRow,0);
			    						
			    						param2 = "ServiceName=C106000060-service&colorAjaxFind=1&SUB_MTL_TP1="+subMtlTp1+"&SUB_MTL_TP2="+subMtlTp2+"&SUB_MTL_TP3="+subMtlTp3+"&SUB_MTL_TP4="+subMtlTp4+"&SUB_MTL_TP5="+subMtlTp5+"&SUB_MTL_TP6="+subMtlTp6+"&CLR_SUB_MTL_CD="+compareCode+"&column-info=RL_LUS_RT";	
			    						...
			    						var num2 = cells2.item(0).firstChild.nodeValue; //비교 대상의 칼라코드 실광택값
			    						...
			    						if(difference > 20){
			    							C10_linkC106000060pop09(topCode,backCode,topNum,backNum,difference);
			    						}
...
// 									items['C106000060_Grid_3'].setCellValue(rId,135, cells.item(23).firstChild.nodeValue);//Type구분									
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),15,cells.item(12).firstChild.nodeValue);//광택도4(하한)
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),132,cells.item(13).firstChild.nodeValue);//광택도4(상한)										
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),27,cells.item(12).firstChild.nodeValue);//광택도3(하한)
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),133,cells.item(13).firstChild.nodeValue);//광택도3(상한)										
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),208,cells.item(21).firstChild.nodeValue);//품질수지3(전면)
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),39,cells.item(12).firstChild.nodeValue);//광택도2(하한)
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),134,cells.item(13).firstChild.nodeValue);//광택도2(상한)										
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),207,cells.item(21).firstChild.nodeValue);//품질수지2(전면)
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),51,cells.item(12).firstChild.nodeValue);//광택도1(하한)
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),135,cells.item(13).firstChild.nodeValue);//광택도1(상한)										
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),206,cells.item(21).firstChild.nodeValue);//품질수지1(전면)
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),63,cells.item(12).firstChild.nodeValue);//광택도1차(후면)	
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),136,cells.item(13).firstChild.nodeValue);//광택도1차(후면)											
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),210,cells.item(21).firstChild.nodeValue);//품질수지1(후면)
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),75,cells.item(12).firstChild.nodeValue);//광택도2차(후면)	
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),137,cells.item(13).firstChild.nodeValue);//광택도2차(후면)											
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),211,cells.item(21).firstChild.nodeValue);//품질수지2(후면)
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),87,cells.item(12).firstChild.nodeValue);//광택도3차(후면)	
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),138,cells.item(13).firstChild.nodeValue);//광택도3차(후면)											
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),212,cells.item(21).firstChild.nodeValue);//품질수지3(후면)
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),99,cells.item(12).firstChild.nodeValue);//광택도4차(후면)	
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),139,cells.item(13).firstChild.nodeValue);//광택도4차(후면)											
									...
									items['C106000060_Grid_1'].setCellValue(grid.getRowSelectedId(),213,cells.item(21).firstChild.nodeValue);//품질수지4(후면)
					...
					if(!isNull(oValue) && isNull(nValue)){
						...
						var cells = xmlObj.getElementsByTagName("cell"); 
							if(cells.length > 0){
									...
									items['C106000060_Grid_3'].setCellValue(rId,12, cells.item(26).firstChild.nodeValue);//품질수지
...
//광택도 차이 Popup호출
function C10_linkC106000060pop09(topCode,backCode,topNum,backNum,difference,callback) {
	popCfmRea		= "";
	
	winObj = new ui.window("popup","Warning","0","0","450","280","C106000060pop09.jsp?TOP="+topCode+"&BACK="+backCode+"&topNum="+topNum+"&backNum="+backNum+"&difference="+difference);
	winObj.setButtonDisable("park,minmax1");

	winObj.getDhxWindow().attachEvent("onClose", function(win){
		this.hide();
		if (typeof callback === "function") {
			callback(true); // 여기서 전달된 콜백 함수가 호출됩니다.
		}
	});
}    
