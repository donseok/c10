...
<%--
 * PROGRAM NAME     :  C106000140pop02.jsp
 * VERSION          :  V1.0
 * DESCRIPTION      :  디지털프린팅 이미지 조회
 * DESIGNER NAME    :  이 돈 석
...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
String DGT_PRT_IMG_NO 	    = request.getParameter("DGT_PRT_IMG_NO");
String DGT_PRT_IMG_SEQ_NO 	= request.getParameter("DGT_PRT_IMG_SEQ_NO");
...
var pageConfiguration = '[' + 
      '{"itemType":"grid","renderTo":"C106000140pop02_Grid_1","xml":".\/header\/kr\/C106000140pop02\/C106000140pop02_Grid_1.xml","rowCnt":"2","vertical":"true","url":"gridC10Data.do","contextmenu":"false","borderline":"true","pageset":"true","split":"0","referenceItem":"C106000140pop02_Form_1","service":"C106000140pop02-service","actionType":"save"},' +
      '{"itemType":"messagebox","renderTo":"C106000140pop02_MessageBox_1","xml":".\/header\/kr\/C106000140pop02\/C106000140pop02_MessageBox_1.xml","service":"C106000140pop02-service"}' +
   ']';
...
/* function refresh(referenceItem){ //grid selection clear event
    ...
    var findUrl = uiCommon.parameters('C106000140pop02_Form_1',referenceItem,'find');
    items[referenceItem].loadData(findUrl);	
} */
...
function findMessage(referenceItem){
	uiCommon.message("C106000140pop02_MessageBox_1",referenceItem.getUserData("","appMsg"));
  	return true;
}
var vault = null;
function onVaultLoad() {
	...
	vault.setFormField("IMG_RGS_FLAG_ID", "<%=DGT_PRT_IMG_NO%>");	
	vault.setFormField("IMG_RGS_FLAG_ID2","<%=DGT_PRT_IMG_SEQ_NO%>");
	...
	vault.onAddFile = function(fileName) {
		...
		*/
		var gridObj = items['C106000140pop02_Grid_1'].getDhxGrid();
...
function onLoadGrid(){
	var grid = items["C106000140pop02_Grid_1"];
	var customparam = {"DGT_PRT_IMG_NO":"<%=DGT_PRT_IMG_NO%>","DGT_PRT_IMG_SEQ_NO":"<%=DGT_PRT_IMG_SEQ_NO%>"};	
	var findUrl  = parametersC10('C106000140pop02_Grid_1','find',customparam);
	items['C106000140pop02_Grid_1'].loadData(findUrl);
...
function doImgDel(rowIdx){
	var gridObj = items["C106000140pop02_Grid_1"].getDhxGrid();
	var DGT_PRT_IMG_NO	    = gridObj.cellById(gridObj.getRowId(rowIdx),gridObj.getColIndexById("DGT_PRT_IMG_NO")).getValue();
	var DGT_PRT_IMG_SEQ_NO	= gridObj.cellById(gridObj.getRowId(rowIdx),gridObj.getColIndexById("DGT_PRT_IMG_SEQ_NO")).getValue();
	...
	del_url += "&IMG_RGS_FLAG_ID="+DGT_PRT_IMG_NO;
	del_url += "&IMG_RGS_FLAG_ID2="+DGT_PRT_IMG_SEQ_NO;
	del_url += "&SEQ="+SEQ;
...
<div id="vault1"></div>
<div id="C106000140pop02_Grid_1" style="position:absolute;height:70px;width:430px;left:8px;top:260px;">
</div>
<div id="C106000140pop02_MessageBox_1" style="position:absolute;height:23px;width:445px;left:0px;top:332px;">
</div>
</body>
</html>
<script>
...
//<![CDATA[
   ui.initializeDHTMLX();  
   var onXleGrid = items["C106000140pop02_Grid_1"].onXLEEvent(onLoadGrid);     
//]]>
-->
</script>