...
var pageConfiguration = '[' + 
      '{"itemType":"form","renderTo":"C106000120_Form_1","xml":".\/header\/kr\/C106000120\/C106000120_Form_1.xml","url":"basicGridData.do","referenceItem":"C106000120_Tabbar_1","service":"C106000120-service"},' +
      '{"itemType":"tabbar","renderTo":"C106000120_Tabbar_1","xml":".\/header\/kr\/C106000120\/C106000120_Tabbar_1.xml","iconImgs":".\/dhtmlx\/codebase\/imgs\/","skin":"modern","service":"C106000120-service"}' +
   ']';
...
function refresh(referenceItem){ //grid selection clear event
    ...
    var findUrl = uiCommon.parameters('C106000120_Form_1',referenceItem,'find');
...
function findMessage(referenceItem){
	uiCommon.message("C106000120_messagebox",referenceItem.getUserData("","appMsg"));
  	return true;
}
...
<body>
<div id="C106000120_Form_1" style="position:absolute;height:50px;width:980px;left:0px;top:0px;">
</div>
<div id="C106000120_Tabbar_1" style="position:absolute;height:562px;width:980px;left:0px;top:31px;">
</div>
</body>
</html>
<script>
