...
<%--
 * PROGRAM NAME     :  C106000050pop06.jsp
 * VERSION          :  V1.0
 * DESCRIPTION      :  칼라코드 내 도장사양서 파일 업로드
 * DESIGNER NAME    :  이 돈 석
 ...
 * ------------  ------    --------  ------------------------
 * 2022.06.22     V1.0      이돈석      Initial Version
--%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
String CLR_SUB_MTL_CD 	     = request.getParameter("CLR_SUB_MTL_CD");
String CLR_SUB_MTL_CD_SEQ_NO = request.getParameter("CLR_SUB_MTL_CD_SEQ_NO");
...
var pageConfiguration = '[' + 
      '{"itemType":"grid","renderTo":"C106000050pop06_Grid_1","xml":".\/header\/kr\/C106000050pop06\/C106000050pop06_Grid_1.xml","rowCnt":"2","vertical":"true","url":"gridC10Data.do","contextmenu":"false","borderline":"true","pageset":"true","split":"0","referenceItem":"C106000050pop06_Form_1","service":"C106000050pop06-service","actionType":"save"},' +
      '{"itemType":"messagebox","renderTo":"C106000050pop06_MessageBox_1","xml":".\/header\/kr\/C106000050pop06\/C106000050pop06_MessageBox_1.xml","service":"C106000050pop06-service"}' +
   ']';
...
function refresh(referenceItem){ //grid selection clear event
    ...
    var findUrl = uiCommon.parameters('C106000050pop06_Form_1',referenceItem,'find');
    items[referenceItem].loadData(findUrl);	
}
...
function findMessage(referenceItem){
	uiCommon.message("C106000050pop06_MessageBox_1",referenceItem.getUserData("","appMsg"));
  	return true;
}
var vault = null;
function onVaultLoad() {
	...
	vault.setFormField("IMG_RGS_FLAG_ID2","<%=CLR_SUB_MTL_CD_SEQ_NO%>");
...
function onLoadGrid(){
	var grid = items["C106000050pop06_Grid_1"];
	var customparam = {"CLR_SUB_MTL_CD":"<%=CLR_SUB_MTL_CD%>","CLR_SUB_MTL_CD_SEQ_NO":"<%=CLR_SUB_MTL_CD_SEQ_NO%>"};	
	var findUrl  = parametersC10('C106000050pop06_Grid_1','find',customparam);
	items['C106000050pop06_Grid_1'].loadData(findUrl);
...
function Grid_doLink(filename,rowId){
	...
	var gridObj = items["C106000050pop06_Grid_1"].getDhxGrid();
...
function doImgDel(rowIdx){
	...
	var CLR_SUB_MTL_CD_SEQ_NO	= gridObj.cellById(gridObj.getRowId(rowIdx),gridObj.getColIndexById("CLR_SUB_MTL_CD_SEQ_NO")).getValue();
	...
	del_url += "&IMG_RGS_FLAG_ID2="+CLR_SUB_MTL_CD_SEQ_NO;
	del_url += "&SEQ="+SEQ;
...
<div id="vault1"></div>
<div id="C106000050pop06_Grid_1" style="position:absolute;height:70px;width:430px;left:8px;top:260px;">
</div>
<div id="C106000050pop06_MessageBox_1" style="position:absolute;height:23px;width:445px;left:0px;top:332px;">
</div>
</body>
</html>
<script>
...
//<![CDATA[
   ui.initializeDHTMLX();  
   var onXleGrid = items["C106000050pop06_Grid_1"].onXLEEvent(onLoadGrid);     
//]]>
-->
</script>