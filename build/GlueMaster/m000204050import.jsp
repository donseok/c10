...
/*
 * @FileName      : 인터페이스전문목록 >> 포맷목록 >> 포맷목록 Import
 * Open Issues    :
 * Change history 
...
<title><%=PosContext.getResourceMessage("GMResource","gm.title.092",null,locale)%> Format import</title>
  ...
  <tr>
    <td valign=top>
      <table width="460" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr height=25>
          <td><div id=gm_title style="font-family:Verdana;font-size:16px;font-weight:bold;color:000033"><%=PosContext.getResourceMessage("GMResource","gm.title.092",null,locale)%> Format import</div></td>
        </tr>
        <tr>
          <td background="img/gm0006img.gif"><img src="img/gm0007img.gif" width=1 height=8></td>
        </tr>
<form name="form_import" method="post" enctype="multipart/form-data" action="m000204050.do">
...
<input type="hidden" name="pfileNm">
        <tr height=50>
          <td><%=PosContext.getResourceMessage("GMResource","gm.msg.0095",null,locale)%> [<a href='m000204050export.jsp?import=format' target="_top">양식 download</a>]<br>
