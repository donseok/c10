...
/*
 * @FileName      : 업무기준 목록 >> 업무기준 목록(Import)
 * Open Issues    :
 * Change history 
 * @2012-01-30 황유진 1.0 최초 생성
 */
...
<title>[import] <%=PosContext.getResourceMessage("GMResource","gm.title.046",null,locale)%></title>
  ...
  <tr>
    <td valign=top>
      <table width="460" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr height=25>
          <td><div id=gm_title style="font-family:Verdana;font-size:16px;font-weight:bold;color:000033">[import] <%=PosContext.getResourceMessage("GMResource","gm.title.046",null,locale)%></div></td>
        </tr>
        <tr>
          <td background="img/gm0006img.gif"><img src="img/gm0007img.gif" width=1 height=8></td>
        </tr>
<form name="form_import" method="post" enctype="multipart/form-data" action="m000202020.do">
...
%>
        ...
        <tr>
          <td align="center"><br><% if(isAdmin){ %>
            ...
            <img src="<%=PosContext.getResourceMessage("GMResource","gm.img.close",null,locale)%>" onclick="reloadOpener()" style="cursor:pointer"><!-- close -->
          </td>
        </tr>
      </table>
    </td>
