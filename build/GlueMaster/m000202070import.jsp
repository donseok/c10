...
<title>[import] <%=PosContext.getResourceMessage("GMResource","gm.title.062",null,locale)%></title>
  ...
  <tr>
    <td valign=top>
      <table width="460" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr height=25>
          <td><div id=gm_title style="font-family:Verdana;font-size:16px;font-weight:bold;color:000033">[import] <%=PosContext.getResourceMessage("GMResource","gm.title.062",null,locale)%></div></td>
        </tr>
        <tr>
          <td background="img/gm0006img.gif"><img src="img/gm0007img.gif" width=1 height=8></td>
        </tr>
<form name="form_import" method="post" enctype="multipart/form-data" action="m000202070.do">
...
%>
        ...
        <tr>
          <td><br><br><div id=gm_import_text><font color="red">
            ...
            <br>■ <%=PosContext.getResourceMessage("GMResource","gm.msg.0086",new Object[]{"6"},locale)%><!-- 항상 15번째 Row부터 데이타를 작성한다. -->
