...
/*
 * @FileName      : 마스타코드 목록 >> 마스타코드 - 카테고리 관리  >> [import] 마스타코드 - 카테고리 관리 
 * Open Issues    :
 * Change history 
...
<title>[import] <%=PosContext.getResourceMessage("GMResource","gm.title.029",null,locale)%></title>
  ...
  <tr>
    <td valign=top>
      <table width="460" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr height=25>
          <td><div id=gm_title style="font-family:Verdana;font-size:16px;font-weight:bold;color:000033">[import] <%=PosContext.getResourceMessage("GMResource","gm.title.029",null,locale)%></div></td>
        </tr>
        <tr>
          <td background="img/gm0006img.gif"><img src="img/gm0007img.gif" width=1 height=8></td>
        </tr>
<form name="form_import" method="post" enctype="multipart/form-data" action="m000201040.do">
...
<input type="hidden" name="CdTp" value="<%=request.getParameter("CdTp")==null?"":request.getParameter("CdTp")%>">
<input type="hidden" name="CdTpMeaning" value="<%=request.getParameter("CdTpMeaning")==null?"":request.getParameter("CdTpMeaning")%>">
<input type="hidden" name="CategoryGroupNm" value="%">
</form>
</body>
</html>