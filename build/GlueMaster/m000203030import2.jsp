...
<title><%=PosContext.getResourceMessage("GMResource","gm.title.074",null,locale)%> 항목 import</title>
...
<input type="hidden" name="pfileNm">
      <table width="460" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr height=25>
          <td><div id=gm_title style="font-family:Verdana;font-size:16px;font-weight:bold;color:000033"><%=PosContext.getResourceMessage("GMResource","gm.title.074",null,locale)%> 항목 import</div></td>
        </tr>
        <tr>
...
<input type="hidden" name="import" value="input">
</form>
</BODY>
</HTML>