...
/*
 * @FileName      : message Import
 * Open Issues    :
 * Change history 
 * @2008-07-11 서정범 1.0 최초 생성
 * @2012-08-09 황유진 #1.4.2 부모창 reload 기능 추가
 */
...
<title>[import] <%=PosContext.getResourceMessage("GMResource","gm.title.013",null,locale)%></title>
  ...
  <tr>
    <td valign=top>
      <table width="460" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr height=25>
          <td><div id=gm_title style="font-family:Verdana;font-size:16px;font-weight:bold;color:000033">[import] <%=PosContext.getResourceMessage("GMResource","gm.title.013",null,locale)%></div></td>
        </tr>
        <tr>
          <td background="img/gm0006img.gif"><img src="img/gm0007img.gif" width=1 height=8></td>
        </tr>
<form name="form_import" method="post" enctype="multipart/form-data" action="m000205020.do">
...
%>
        ...
        <tr>
          <td><br><br><div id=gm_import_text><font color="red">
            ...
            <br>■ <%=PosContext.getResourceMessage("GMResource","gm.msg.0065",null,locale)%><!-- 첫번째 WorkSheet에 등록 또는 수정할 데이타를 작성한다. -->
            <br>■ <%=PosContext.getResourceMessage("GMResource","gm.msg.0086",new Object[]{"2"},locale)%><!-- 항상 2번째 Row부터 데이타를 작성한다. -->
        ...
        <tr>
          <td align="center"><br><% if(isAdmin){ %>
            ...
            <img src="<%=PosContext.getResourceMessage("GMResource","gm.img.close",null,locale)%>" onclick="gm_close()" style="cursor:pointer"><!-- close -->
          </td>
        </tr>
      </table>
    </td>
