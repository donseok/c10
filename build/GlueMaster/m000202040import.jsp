...
/*
 * @FileName      : 업무기준 목록 >> 업무기준 기본속성 등록 >> 업무기준 레이아웃 수정 >> 업무기준 데이터 조회(일반)(Import)
 *                  업무기준 목록 >> 업무기준 기본속성 등록 >> 업무기준 데이터 조회(일반)(Import)
 * Open Issues    :
 * Change history 
...
<title>[import] <%=PosContext.getResourceMessage("GMResource","gm.title.054",null,locale)%></title>
...
function reloadOpener(){
    window.opener.document.forms[0].action = window.opener.document.forms[0].action+"?saveData=true";
  ...
  <tr>
    <td valign=top>
      <table width="460" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr height=25>
          <td><div id=gm_title style="font-family:Verdana;font-size:16px;font-weight:bold;color:000033">[import] <%=PosContext.getResourceMessage("GMResource","gm.title.054",null,locale)%></div></td>
        </tr>
        <tr>
          <td background="img/gm0006img.gif"><img src="img/gm0007img.gif" width=1 height=8></td>
        </tr>
<form name="form_import" method="post" enctype="multipart/form-data" action="m000202040.do">
...
%>
        ...
        <tr>
          <td><br><br><div id=gm_import_text><font color="red">
            ...
            <br>■ <%=PosContext.getResourceMessage("GMResource","gm.msg.0086",new Object[]{"5"},locale)%><!-- 항상 15번째 Row부터 데이타를 작성한다. -->
