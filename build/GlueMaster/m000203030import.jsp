...
/*
 * @FileName      : 계산수식 목록 >> 계산수식 목록(Import)
 * Open Issues    :
 * Change history 
 * @LastModifyDate: 20120130
 * @LastModifier  : 황유진
 * @LastVersion   : 1.0
 *    2012-01-30   황유진
 *        1.0      최초 생성
...
<title><%=PosContext.getResourceMessage("GMResource","gm.title.074",null,locale)%> 구조식 import</title>
...
<table width="480" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign=top>
<form name="form_import" method="post" enctype="multipart/form-data" action="m000203030.do">
...
<input type="hidden" name="pfileNm">
      <table width="460" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr height=25>
          <td><div id=gm_title style="font-family:Verdana;font-size:16px;font-weight:bold;color:000033"><%=PosContext.getResourceMessage("GMResource","gm.title.074",null,locale)%> 구조식 import</div></td>
        </tr>
        <tr>
              ...
              <tr align="center">
                <td align="left"><%
                  ...
                  if(result != null)
                  {
                      ...
                      out.println("<br>■ "+PosContext.getResourceMessage("GMResource","gm.msg.0047",null,locale)+"    : "+result.get("DeleteCnt")+"<br>");//수정데이타수
...
<input type="hidden" name="import" value="fomula">
</form>
</BODY>
</HTML>