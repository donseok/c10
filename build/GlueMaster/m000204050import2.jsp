...
<title><%=PosContext.getResourceMessage("GMResource","gm.title.092",null,locale)%> TC import</title>
  ...
  <tr>
    <td valign=top>
      <table width="460" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr height=25>
          <td><div id=gm_title style="font-family:Verdana;font-size:16px;font-weight:bold;color:000033"><%=PosContext.getResourceMessage("GMResource","gm.title.092",null,locale)%> TC import</div></td>
        </tr>
        <tr>
...
<input type="hidden" name="pfileNm">
        <tr height=50>
          <td><%=PosContext.getResourceMessage("GMResource","gm.msg.0095",null,locale)%> [<a href='m000204050export.jsp?import=tc' target="_top">양식 download</a>]<br>
