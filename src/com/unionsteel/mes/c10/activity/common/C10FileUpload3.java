 ...
 * class="com.unionsteel.mes.C10.common.C10FileUpload3"> </activity> *
 * 
 * Property 상세
 * 
 * </xmp>
 ...
 */
public class C10FileUpload3 extends PosActivity {
	/**
	...
	public String runActivity(PosContext ctx) {
		...
		try {
			...
			param.setNamedParamter("IMG_RGS_FLAG_ID" ,ctx.get("IMG_RGS_FLAG_ID"));
			param.setNamedParamter("IMG_RGS_FLAG_ID2",ctx.get("IMG_RGS_FLAG_ID2"));
			param.setNamedParamter("IMG_RGS_FLAG_ID3",ctx.get("IMG_RGS_FLAG_ID3"));
