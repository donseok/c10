...
* @FileName : c10FileUpload.java
* Change history
* @LastModifyDate : 2012. 05. 05
* @LastModifier : 김종범
* @LastVersion : 1.0
* 1.0 2012. 05. 05    김종범    최초 생성
===========================================================================*/
 ...
 * <xmp>
 * 사용방법
 * <activity name="엑셀파일업로드" class="com.unionsteel.mes.c10.common.c10FileUpload">
 * </activity> * 
 * 
 * Property 상세
 * 
 ...
 */
public class C10FileUpload extends PosActivity {
	/**
	...
	public String runActivity(PosContext ctx){ 
		...
		try{
			...
			param.setNamedParamter("QLT_IMV_REQ_NO"        , ctx.get("QLT_IMV_REQ_NO"));
			param.setNamedParamter("IMG_NM"				   , ctx.get("IMG_NM"));
			param.setNamedParamter("IMG_ADR"			   , ctx.get("IMG_ADR"));				
			

			int cnt = dao.insert("C106000030pop01.insert" , param);
			if(cnt < 0){
