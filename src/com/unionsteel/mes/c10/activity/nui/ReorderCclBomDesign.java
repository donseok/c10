/*
 * ==============================================================================
 * Copyright(c) 2014 UNIONSTEEL
 * @FileName : ReorderCclBomDesign.java
 * Change history
 * @LastModifyDate : 2014. 08. 25
 * @LastModifier : 이돈석
 * @LastVersion : 1.0
 * 1.0 2014. 08. 25 이돈석 최초 생성
 * ==============================================================================
 */
 ...
 * 사용 방법
 * <activity name="SEARCH_MD" class="com.unionsteel.mes.c10.activity.nui.ReorderCclBomDesign">
 * <transition name="success" value="C102100170-service" />
...
public class ReorderCclBomDesign extends PosActivity implements C10NuiConstantsIF
{
