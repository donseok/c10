...
public class C10UiCheckActivity2 extends PosActivity
{
            ...
            { // 작업지시변경저장 coil
                ...
                for ( int i = 0, n = idsValue.length; i < n; i++ )
                {
                    ...
                    if ( ORD_NO.length > 0 && ORD_LN.length > 0 )
                    {
                        ...
                        rowset = mesdao.find( C10ConstantsIF.C104000050_CHECK2, param );

                        logger.logDebug( C10ConstantsIF.SELECT_COUNT + rowset.count() );
                        if ( rowset.count() == 0 )
                        {
                            // error
                            logger.logError( C10ConstantsIF.C104000050_CHECK_ERR2 );
                            // throw new PosException( C10ConstantsIF.C104000050_CHECK_ERR );

                            ctx.put( C10ConstantsIF.ERRMSG, C10ConstantsIF.C104000050_CHECK_ERR2 );
                        ...
                        nRELULT = mesdao.update( C10ConstantsIF.C104000050_UPDATE2, param );
                        logger.logDebug( C10ConstantsIF.C104000050_UPDATE2 );
                        ...
                        param.setNamedParamter( C10ConstantsIF.COL_QLT_DSN_STS, C10ConstantsIF.R );
